...
if($ok==1){
	...
	$filetmp = "../tmp_img_file/".$filename2.".*";
	...
	if (is_uploaded_file($_FILES["upfile"]["tmp_name"])) {
	  if (move_uploaded_file($_FILES["upfile"]["tmp_name"], "../tmp_img_file/" . $filename)) {
	    chmod("../tmp_img_file/".$filename, 0644);
			
		  	//アップロード
		  	$sql = "INSERT INTO soundways_sound_tmp(sound_tmp_id,sound_filename,user_id) VALUES ('$sound_tmp_img_num','$filename','$user_id')";
