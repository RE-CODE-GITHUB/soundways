...
<img src='../userimg/$user_img' style='width:25px;height:25px;border-radius:50px;vertical-align: middle;margin-bottom:3px;'>
...
<a href="/user/" class="top_menu_btn" style='width:140px;'><i class="fa fa-heart" style='font-size:16px;margin-right:5px;'></i>お気に入り</a>
