...
$following_r = mysql_query("SELECT * from soundways_following WHERE following_user_id = '".$creator_id."'");
...
<div style="background:white;width:100%;height:50px;line-height:50px;">
	<div style="width:1200px;margin:auto;font-size:14px;">
		...
		<a href="following.php?id=<?php echo $creator_id;?>" class="menu_hover" style="display:block;float:left;width:120px;text-align:center;color:#ff5a5f;">
...
if($user_id != $creator_id){
	...
	if($follow_sw==0){
		...
		echo "<a href='cgi/follow.php?id=$creator_id&type=2' style='display:block;float:right;width:160px;margin-top:5px;background:#59c146;height:40px;line-height:40px;border-radius:10px;text-align:center;color:#fff;font-size:18px;'>フォローする</a>";
		
	}else{
	
		echo "<a href='cgi/follow.php?id=$creator_id&type=2&del=1' style='display:block;float:right;width:160px;margin-top:5px;background:#59c146;height:40px;line-height:40px;border-radius:10px;text-align:center;color:#fff;font-size:18px;'>フォロー中</a>";
...
$following_user_r = mysql_query("SELECT * from soundways_user_info WHERE user_id = '".$row["followed_user_id"]."'");
...
if($following_count%2==1){
	echo "<div style='float:left;background:white;height:200px;width:590px;margin-right:20px;margin-bottom:20px;box-shadow:0px 0px 1px 0px #ddd;'>";
}else{
	echo "<div style='float:left;background:white;height:200px;width:590px;margin-bottom:20px;box-shadow:0px 0px 1px 0px #ddd;'>";
}
print<<<EOC
